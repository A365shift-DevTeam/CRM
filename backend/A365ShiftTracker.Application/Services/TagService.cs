...
public class TagService : ITagService
{
    ...
    public TagService(IUnitOfWork uow, ILogger<TagService> logger)
    {
        _uow = uow;
        _logger = logger;
    }
    ...
    public async Task<IEnumerable<TagDto>> GetAllTagsAsync(int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(GetAllTagsAsync));
            throw;
        }
    }
    ...
    public async Task<TagDto> CreateTagAsync(CreateTagRequest request, int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(CreateTagAsync));
            throw;
        }
    }
    ...
    public async Task<TagDto> UpdateTagAsync(int id, CreateTagRequest request, int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(UpdateTagAsync));
            throw;
        }
    }
    ...
    public async Task DeleteTagAsync(int id, int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(DeleteTagAsync));
            throw;
        }
    }
    ...
    public async Task AttachTagAsync(AttachTagRequest request, int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(AttachTagAsync));
            throw;
        }
    }
    ...
    public async Task DetachTagAsync(int tagId, string entityType, int entityId, int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(DetachTagAsync));
            throw;
        }
    }
}
