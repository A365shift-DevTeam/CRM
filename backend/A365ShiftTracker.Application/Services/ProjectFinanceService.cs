...
public class ProjectFinanceService : IProjectFinanceService
{
    ...
    private readonly ILogger<ProjectFinanceService> _logger;

    public ProjectFinanceService(IUnitOfWork uow, IInvoiceService invoiceService, ILogger<ProjectFinanceService> logger)
    {
        _logger = logger;
        _uow = uow;
