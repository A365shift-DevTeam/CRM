...
public class NotificationService : INotificationService
{
    ...
    public async Task<int> GetUnreadCountAsync(int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(GetUnreadCountAsync));
            throw;
        }
    }
    ...
    public async Task MarkAsReadAsync(int id, int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(MarkAsReadAsync));
            throw;
        }
    }
    ...
    public async Task MarkAllAsReadAsync(int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(MarkAllAsReadAsync));
            throw;
        }
    }
    ...
    public async Task<IEnumerable<AlertDto>> GenerateAlertsAsync(int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(GenerateAlertsAsync));
            throw;
        }
    }
