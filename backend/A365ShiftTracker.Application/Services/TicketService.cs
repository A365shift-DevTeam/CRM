...
public class TicketService : ITicketService
{
    ...
    public TicketService(IUnitOfWork uow, IDapperContext db, ILogger<TicketService> logger)
    {
        _logger = logger;
        _uow = uow;
        _db = db;
    ...
    public async Task<TicketStatsDto> GetStatsAsync(int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(GetStatsAsync));
            throw;
        }
    }
    ...
    public async Task<TicketDto?> GetByIdForAdminAsync(int ticketId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(GetByIdForAdminAsync));
            throw;
        }
    }
    ...
    public async Task<TicketCommentDto> AddCommentAsync(int ticketId, CreateTicketCommentRequest req, int userId)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(AddCommentAsync));
            throw;
        }
    }
    ...
    public async Task<TicketCommentDto> AdminReplyAsync(int ticketId, CreateTicketCommentRequest req, int adminUserId)
    {
        try
        {
            var ticket = await _uow.Tickets.FirstOrDefaultAsync(t => t.Id == ticketId, tracking: true)
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(AdminReplyAsync));
            throw;
        }
    }
    ...
    public async Task<TicketDto?> AdminSetStatusAsync(int ticketId, string status)
    {
        ...
        {
            _logger.LogError(ex, "Error in {Method}", nameof(AdminSetStatusAsync));
            throw;
        }
    }
